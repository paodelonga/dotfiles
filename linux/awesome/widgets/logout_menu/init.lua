...
local popup = awful.popup({
    ...
    border_width = dpi(1),
    border_color = "#36366BAF",
    maximum_width = dpi(400),
    offset = { y = dpi(6), x = dpi(18) },
    widget = {},
})
...
local function worker(user_args)
    ...
    local onrestart = args.onrestart or function()
        awesome.restart()
    end

    local menu_items = {
        { name = "Quit", icon_name = "log-out.svg", command = onlogout },
        { name = "Restart", icon_name = "refresh-cw.svg", command = onrestart },
